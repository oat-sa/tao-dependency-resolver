...
class RootPackageInstaller
{
     ...
     */
    public function install(Config $config, Extension $rootExtension, string $directory): int
    {
        $packageName = $rootExtension->getComposerName() . ':' . $rootExtension->getPrefixedBranchName();

        echo 'Installing root repository: ', $packageName, '.', "\n";
