    ...
    'install' => [
        'rdf' => [
            [
                ...
                'file' => dirname(__FILE__) . '/core/ontology/22-rdf-syntax-ns.rdf',
            ],
            [
                'ns' => 'http://www.w3.org/2000/01/rdf-schema',
                'file' => dirname(__FILE__) . '/core/ontology/rdf-schema.rdf',
            ],
            [
                'ns' => 'http://www.tao.lu/datatypes/WidgetDefinitions.rdf',
                'file' => dirname(__FILE__) . '/core/ontology/widgetdefinitions.rdf',
            ],
            [
                'ns' => 'http://www.tao.lu/middleware/Rules.rdf',
                'file' => dirname(__FILE__) . '/core/ontology/rules.rdf',
            ],
            [
                'ns' => 'http://www.tao.lu/Ontologies/generis.rdf',
                'file' => dirname(__FILE__) . '/core/ontology/generis.rdf',
            ],
            [
                'ns' => 'http://www.tao.lu/Ontologies/taskqueue.rdf',
                'file' => dirname(__FILE__) . '/core/ontology/taskqueue.rdf',
            ],
        ],
        'checks' => [],
        'php' => [
